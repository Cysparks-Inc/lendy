-- Migration: Fix get_unified_overdue_loans_report function structure mismatch
...
-- Create the fixed function with proper structure
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Fixed unified overdue loans calculation with proper JOIN handling and structure matching';
