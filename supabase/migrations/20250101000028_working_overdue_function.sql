-- Migration: Working overdue function with correct data types
-- This fixes the data type mismatches
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Working overdue function with correct data types and full functionality';
