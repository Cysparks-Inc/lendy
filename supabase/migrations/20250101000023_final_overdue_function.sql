-- Migration: Final fix for get_unified_overdue_loans_report function
-- This uses the actual column names from the loans table

-- Drop existing function
DROP FUNCTION IF EXISTS get_unified_overdue_loans_report(UUID) CASCADE;
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Final corrected unified overdue loans calculation using actual column names';
