-- Migration: Fix get_unified_overdue_loans_report function with correct column names
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Corrected unified overdue loans calculation with proper column references';
