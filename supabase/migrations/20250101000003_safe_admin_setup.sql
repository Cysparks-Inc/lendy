-- Safe migration that works with existing enum values
-- First, let's check what enum values actually exist and work with them

-- Create a function that checks what roles exist and works with them
...
-- Create a function for super admin check
