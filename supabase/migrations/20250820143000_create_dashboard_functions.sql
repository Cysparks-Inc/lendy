-- Create dashboard functions for different user roles
-- This migration adds functions to get dashboard stats and recent loans based on user role
...
BEGIN
  ...
  SELECT ur.role, ur.branch_id INTO user_role, user_branch_id
  FROM user_roles ur
...
-- Function to get recent loans based on user role
