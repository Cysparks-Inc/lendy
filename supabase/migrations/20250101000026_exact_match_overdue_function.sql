-- Migration: Exact match for get_unified_overdue_loans_report function
-- This matches the TypeScript interface exactly

-- First, drop the existing function
DROP FUNCTION get_unified_overdue_loans_report(UUID);

-- Create the function that matches the TypeScript interface exactly
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Exact match for TypeScript interface - fixed return type structure';
