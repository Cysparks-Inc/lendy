-- Migration: Drop and recreate get_unified_overdue_loans_report function
-- This handles the return type change properly

-- First, drop the existing function
DROP FUNCTION get_unified_overdue_loans_report(UUID);

-- Now create the corrected function with actual column names
...
-- Add comment
COMMENT ON FUNCTION get_unified_overdue_loans_report(UUID) IS 'Recreated unified overdue loans calculation with correct return type and column names';
