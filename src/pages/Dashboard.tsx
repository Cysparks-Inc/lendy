    ...
    const fetchDashboardStats = async () => {
      try {
        ...
        const { data: loans } = await supabase
          .from('loans')
          .select('principal_amount, current_balance, status');
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            ...
            <Badge variant="secondary" className="bg-success-light text-success-foreground">Active</Badge>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            ...
            <Badge variant="secondary" className="bg-success-light text-success-foreground">Completed</Badge>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            ...
            <Badge variant="secondary" className="bg-destructive-light text-destructive-foreground">Defaulted</Badge>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-success">
                  {stats.totalLoanAmount > 0 
                    ? ((stats.totalRepaid / stats.totalLoanAmount) * 100).toFixed(1)
                    : '0'}%
                </span>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-destructive">
                  {stats.totalLoans > 0 
                    ? ((stats.defaultedLoans / stats.totalLoans) * 100).toFixed(1)
                    : '0'}%
                </span>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">
                  {stats.totalLoans > 0 
                    ? formatCurrency(stats.totalLoanAmount / stats.totalLoans)
                    : formatCurrency(0)}
                </span>
              </div>
            </div>
