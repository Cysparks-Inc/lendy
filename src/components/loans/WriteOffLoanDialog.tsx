        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <div className="space-y-4 py-4">
                    ...
                    {selectedLoan && <Card className="bg-muted/50"><CardContent className="p-4 text-sm">You have selected to write off <strong>{selectedLoan.member_name}'s</strong> loan with a balance of <strong>{new Intl.NumberFormat('en-KE', { style: 'currency', currency: 'KES' }).format(selectedLoan.current_balance)}</strong>.</CardContent></Card>}
